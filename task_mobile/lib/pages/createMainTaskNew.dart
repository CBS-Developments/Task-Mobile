...
class CreateMainTaskPage extends StatefulWidget {
  const CreateMainTaskPage({Key? key}) : super(key: key);

  @override
  State<CreateMainTaskPage> createState() => _CreateMainTaskPageState();
}

class _CreateMainTaskPageState extends State<CreateMainTaskPage> {
  String userName = "";
  String firstName = "";
  String lastName = "";
  String phone = "";
                            ...
                            children: [
                              Expanded(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Text("Beneficiary:  ",style: TextStyle(color: AppColor.tealLog,fontSize: 15),),
                                      Expanded(
                                            ...
                                            return TextField(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                enabledBorder: UnderlineInputBorder(
                                                  borderSide: BorderSide(color: Colors.teal), // Normal border color
                                                ),
                                                focusedBorder: UnderlineInputBorder(
                                                  borderSide: BorderSide(color: AppColor.tealLog), // Focus color
                                                ),
                                              ),
                                            );
                                          },
                              ...
                              Expanded(
                                ...
                                child: Padding(
                                  ...
                                  child: MultiSelectFormField(
                                    ...
                                    title: Text('Assign To: ',style: TextStyle(color: AppColor.tealLog,fontSize: 15),),
                                    dataSource: const [
                                      {
                                        "display": "Deshika",
                                        "value": "Deshika",
                                    ...
                                    textField: 'display',
                                    hintWidget: const Text('Tap to select assignees'),
                                    valueField: 'value',
                                    okButtonLabel: 'OK',
                            ...
                            children: [
                              Expanded(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Text("Priority:  ",style: TextStyle(color: AppColor.tealLog,fontSize: 15),),
                                      Expanded(
                                        child: Autocomplete<String>(
                                          optionsBuilder: (TextEditingValue textEditingValue) {
                            ...
                            children: [
                              Expanded(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Text("Source From:  ",style: TextStyle(color: AppColor.tealLog,fontSize: 15),),
                                      Expanded(
                                        child: Autocomplete<String>(
                                          optionsBuilder: (TextEditingValue textEditingValue) {
                                            return ['Skype',
                            ...
                            children: [
                              Expanded(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Text("Category:  ",style: TextStyle(color: AppColor.tealLog,fontSize: 15),),
